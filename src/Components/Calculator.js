        ...
        <div className='body'>
            <div className="calculator-container">
                ...
                <div className='input-fiels'>
                    <input type="text" name="num1" value={num1} onChange={(e) => {setNum1(e.target.value)}} placeholder='Num1'/>
                    <input type="text" name="num2" value={num2} onChange={(e) => {setNum2(e.target.value)}} placeholder='Num2'/>
                </div>
